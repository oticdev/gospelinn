...
export default function PastorSpotlight() {
  ...
  return (
    <section id="pastor" className="py-24 bg-[#0F172A] relative overflow-hidden">
      {/* Decorative Glows */}
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-96 h-96 bg-[#6E0A1A]/20 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#6E0A1A]/30 border border-[#6E0A1A] text-xs font-bold text-[#38BDF8] uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              {/* Decorative Frame */}
              <div className="absolute -inset-2 rounded-3xl bg-gradient-to-tr from-[#6E0A1A] via-[#38BDF8] to-[#6E0A1A] opacity-40 blur-xl"></div>
              ...
              <div
                ...
                className="relative rounded-3xl overflow-hidden glass-panel border border-white/15 shadow-2xl cursor-pointer group/connect hover:border-[#38BDF8]/50 transition-colors"
              >
                <div className="relative h-[480px] w-full">
                  ...
                  {/* Connect Hint */}
                  <div className="absolute top-4 right-4 glass-panel px-3 py-1.5 rounded-full text-[10px] font-bold text-[#38BDF8] uppercase tracking-wider flex items-center gap-1.5">
                    <UserPlus className="w-3.5 h-3.5" />
                    Connect &amp; Invite
                  </div>

                  {/* Badge */}
                  <div className="absolute bottom-6 left-6 right-6 glass-panel-oxblood p-4 rounded-2xl border border-[#6E0A1A]">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="glass-panel p-6 rounded-3xl border border-white/10 relative">
              <Quote className="w-10 h-10 text-[#6E0A1A] opacity-60 absolute top-4 right-4" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-[#38BDF8]/40 transition-colors">
                <div className="w-10 h-10 rounded-xl bg-[#6E0A1A]/40 border border-[#6E0A1A] flex items-center justify-center text-[#38BDF8] mb-3">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <a
                href="#schedule"
                className="px-6 py-3 rounded-xl font-bold text-xs text-white bg-gradient-to-r from-[#6E0A1A] to-[#9E1B32] border border-[#38BDF8]/30 shadow-lg hover:shadow-[#38BDF8]/20 transition-all"
              >
        ...
        <PastorConnectModal isOpen={connectOpen} onClose={() => setConnectOpen(false)} />
      </div>
    </section>
  );
}
