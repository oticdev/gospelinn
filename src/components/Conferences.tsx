...
import { Sparkles, Users, Award, Shield, Music, Flame, HeartHandshake, ChevronRight, Phone, MessageCircle, ClipboardList, type LucideIcon } from "lucide-react";
import Modal from "./Modal";
import { OFFICE_PHONE_DISPLAY, OFFICE_PHONE_TEL, OFFICE_WHATSAPP } from "@/lib/contact";
...
const conferences: Conference[] = [
  ...
  },
  {
    ...
    title: "STRASODA – Strategic Sons and Daughters Gathering",
    acronym: "STRASODA",
    tagline: "Raising Kingdom Heirs with Purpose, Anointing & Destiny",
    demographic: "Young Adults, Sons & Daughters of the Kingdom",
    description: "The flagship convention empowering strategic sons and daughters to walk in spiritual authority, discover divine purpose, and carry the gospel with boldness and anointing.",
    icon: Sparkles,
    color: "skyblue",
      ...
      {selectedConference && (
        ...
        >
          <div className="space-y-1">
            ...
            <h3 id="conference-title" className="text-2xl font-black text-white">{selectedConference.title}</h3>
